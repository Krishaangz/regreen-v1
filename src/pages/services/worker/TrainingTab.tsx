...
const TrainingTab = ({ programs, onViewDetails }: TrainingTabProps) => {
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground mb-6">
          Develop the specialized skills needed for ecological restoration work through our 
          comprehensive training programs. From beginners to experienced professionals looking 
          to expand their expertise, we offer programs for all skill levels.
        </p>
      </div>
