          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground pl-8">
                  Project timelines vary based on size, complexity, and seasonal factors. Small projects may take 2-4 weeks, while larger transformations can span 2-3 months. Our AI-driven planning provides accurate timelines during the proposal phase.
                </p>
              </div>
              ...
              <div className="space-y-2">
                <div className="flex gap-3 items-start">
                  <HelpCircle className="h-5 w-5 text-regreen-600 flex-shrink-0 mt-0.5" />
                  <h4 className="font-medium">What qualifications do workers need?</h4>
                </div>
                <p className="text-sm text-muted-foreground pl-8">
                  Workers should have basic physical abilities and willingness to learn. Experience in gardening, landscaping, or construction is beneficial but not required. We provide on-the-job training and skill development opportunities.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                <div className="flex gap-3 items-start">
                  <HelpCircle className="h-5 w-5 text-regreen-600 flex-shrink-0 mt-0.5" />
                  <h4 className="font-medium">How is payment structured for landowners?</h4>
                </div>
                <p className="text-sm text-muted-foreground pl-8">
                  Landowners pay 50% of the project cost upfront to initiate the temporary group formation. The remaining 50% is due upon satisfactory project completion and verification.
                </p>
              </div>
              ...
              <div className="space-y-2">
                <div className="flex gap-3 items-start">
                  <HelpCircle className="h-5 w-5 text-regreen-600 flex-shrink-0 mt-0.5" />
                  <h4 className="font-medium">How are workers compensated?</h4>
                </div>
                <p className="text-sm text-muted-foreground pl-8">
                  Workers receive payment through our secure Eco-Wallet system after successful task verification. Payment rates vary based on task complexity, duration, and skill requirements, with bonuses for exceptional performance.
                </p>
              </div>
              ...
              <div className="space-y-2">
                <div className="flex gap-3 items-start">
                  <HelpCircle className="h-5 w-5 text-regreen-600 flex-shrink-0 mt-0.5" />
                  <h4 className="font-medium">Is ongoing maintenance included?</h4>
                </div>
                <p className="text-sm text-muted-foreground pl-8">
                  Initial projects focus on transformation. We offer separate maintenance packages to ensure long-term success of your eco-restoration project, with options for scheduled worker visits or community volunteer programs.
                </p>
              </div>
            </div>
          </div>
